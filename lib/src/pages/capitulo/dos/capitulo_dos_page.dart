...
import 'package:book/src/models/capitulo_dos.dart';

import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

import 'capitulo_dos_controller.dart';



class CapituloDosPage extends StatefulWidget {
  const CapituloDosPage({Key? key}) : super(key: key);

  @override
  _CapituloDosPageState createState() => _CapituloDosPageState();
}

class _CapituloDosPageState extends State<CapituloDosPage> {

  CapituloDosController _con=new CapituloDosController();
          ...
          ValueListenableBuilder<double>(
              ...
              builder: (context, value,_) {
                return PageView.builder(
                  itemCount: capitulo_dos.length,
                  controller:_controller,
                  itemBuilder: (context,index){
                    final contenido=capitulo_dos[index];
                                        ...
                                        children:[
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text('Página ${1+index}/${capitulo_dos.length} ',style: TextStyle(
                                                  fontSize: 10,
                                                  color: Colors.blueGrey
                                              ),)
